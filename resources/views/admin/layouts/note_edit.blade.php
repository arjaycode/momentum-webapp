...
<main class="main-content">
  ...
  <div class="form-container">
    <form action="{{ route('admin.note-management.update', $note->id) }}" method="POST">
      @csrf
      @method('PUT')
      @if (session('success'))
      ...
      <div class="form-row">
        <div class="form-group">
          ...
          <select name="user_id" id="userSelect" class="select-input" required>
            ...
            <option value="{{ $user->id }}" {{ old('user_id', $note->user_id) == $user->id ? 'selected' : '' }}>
        ...
        <div class="form-group">
          ...
          <select name="habit_id" id="habitSelect" class="select-input">
            ...
            <option value="{{ $habit->id }}" {{ old('habit_id', $note->habit_id) == $habit->id ? 'selected' : '' }}>
      ...
      <div class="form-group">
        ...
        <textarea name="message" id="noteText" class="textarea-input" placeholder="Put your note here..." required>{{ old('message', $note->message) }}</textarea>
      </div>
