<template>
  <Head title="Edit Note - Momentum" />

  <AdminLayout 
    activeLink="notes" 
    pageTitle="Edit Note" 
    pageDescription="Modify an existing user note"
  >
          ...
          <form @submit.prevent="submit" class="space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6">
              ...
              <div>
                ...
                <textarea v-model="form.message" rows="6" class="w-full px-4 py-3 rounded-xl border border-gray-300 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors" required></textarea>
...
const submit = () => {
  form.patch(admin.noteManagement.update(props.note.id).url);
};
</script>
