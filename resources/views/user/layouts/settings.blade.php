...
@section('title', 'Settings | Username')
...
<div class="screen" id="privacy-screen">
  <div class="tabs">
    ...
    <div class="tab" data-screen="privacy-screen" onclick="showScreen('privacy-screen', this)">
      Privacy
    </div>
  </div>
  ...
  <div class="content">
    <div class="section">
      <div class="section-header">Lock Account Security</div>
      ...
      <div class="security-item">
        <div class="security-info">
          ...
          <p>View and manage active sessions across devices</p>
        </div>
  ...
  <div class="content">
    ...
    <div class="section" style="max-width: 600px">
      ...
      <div class="form-actions">
        <button class="btn btn-secondary" onclick="showScreen('profile-screen', document.querySelector('.tabs .tab[data-screen=\'profile-screen\']'))">
          Cancel
        </button>
        ...
        <div class="section">
          ...
          <div class="profile-header">
            <div class="profile-avatar">
              ...
              <button class="change-photo-btn">Camera</button>
            </div>
            <div>
              <div class="profile-name">John Doe</div>
              <div class="profile-member">Member since August 2025</div>
          ...
          <div class="form-group">
            ...
            <input type="email" class="form-input" value="JohnDoe@email.com" />
          </div>
        ...
        <div class="section">
          <div class="preference-item">
            <div>
              ...
              <p style="font-size: 13px; color: #666">
                Get notified about your habits and progress
              </p>
            </div>
          ...
          <div class="preference-item">
            <div>
              ...
              <p style="font-size: 13px; color: #666">
                Remind me to complete my daily habits
              </p>
            </div>
            <div class="toggle active" onclick="toggleSwitch(this)"></div>
          </div>
          ...
          <div class="preference-item">
            <div>
              ...
              <p style="font-size: 13px; color: #666">
                Receive daily inspirational messages
              </p>
            </div>
            <div class="toggle active" onclick="toggleSwitch(this)"></div>
          </div>
