 ...
 * @route '/forgot-password'
 */
    const showForgotPasswordFormForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: showForgotPasswordForm.url(options),
        method: 'get',
    })
 ...
 * @route '/forgot-password'
 */
        showForgotPasswordFormForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: showForgotPasswordForm.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/forgot-password'
 */
        showForgotPasswordFormForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: showForgotPasswordForm.url({
    ...
    showForgotPasswordForm.form = showForgotPasswordFormForm
/**
