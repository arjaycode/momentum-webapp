  ...
  <UserLayout>
    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-4xl mx-auto">
      ...
      <div class="mb-8">
        ...
        <h1 class="text-2xl md:text-3xl text-gray-800 font-bold tracking-tight">Edit Habit</h1>
      </div>
            ...
            <div class="sm:col-span-6">
              ...
              <div class="mt-1">
                <textarea id="description" rows="3" v-model="form.description"
                  class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border border-gray-300 rounded-lg p-3 outline-none"></textarea>
              </div>
...
const submit = () => {
  form.post(user.habits.update({ id: props.habit.id }).url);
};
</script>
