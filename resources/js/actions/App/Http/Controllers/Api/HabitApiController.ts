...
/**
* @see \App\Http\Controllers\Api\HabitApiController::markAsDone
...
const HabitApiController = { index, show, store, update, destroy, markAsDone }

export default HabitApiController