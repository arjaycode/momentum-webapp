 ...
 * @route '/admin/habit-management'
 */
    const habitManagementForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: habitManagement.url(options),
        method: 'get',
    })
 ...
 * @route '/admin/habit-management'
 */
        habitManagementForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: habitManagement.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/admin/habit-management'
 */
        habitManagementForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: habitManagement.url({
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
    ...
    habitManagement.form = habitManagementForm
/**
 ...
 * @route '/admin/note-management'
 */
    const noteManagementForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: noteManagement.url(options),
        method: 'get',
    })
 ...
 * @route '/admin/note-management'
 */
        noteManagementForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: noteManagement.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/admin/note-management'
 */
        noteManagementForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: noteManagement.url({
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
    ...
    noteManagement.form = noteManagementForm
/**
