...
@section('page-description', 'See your habit details')
...
<div class="content-area">
  <div class="details-section">
    <div class="form-group">
      ...
      <input type="text" class="form-input" id="habitTitle" value="Study" />
    </div>
    ...
    <div class="form-group">
      ...
      <textarea class="form-textarea" id="habitDesc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam quo molestias iusto optio, hic praesentium libero temporibus, accusantium provident eos dolore ut deserunt, vel officia consectetur dolor voluptatum tempora? Corrupti.</textarea>
    </div>
