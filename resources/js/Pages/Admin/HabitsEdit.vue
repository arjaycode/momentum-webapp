...
import { update } from '@/actions/App/Http/Controllers/Admin/AdminHabitController';
...
const form = useForm({
    user_id: props.habit.user_id,
    category_id: props.habit.category_id ?? ('' as const),
    name: props.habit.name,
    description: props.habit.description ?? '',
    enable_push_notifications: props.habit.enable_push_notifications,
    target_days: [...props.targetDays] as string[],
});
...
function submit() {
    form
        ...
        .put(update.put({ id: props.habit.id }));
}

let scriptEl: HTMLScriptElement | null = null;
onMounted(() => {
    scriptEl = document.createElement('script');
    scriptEl.src = '/AdminSide/js/edit_habit.js';
...
<template>
    <AdminLayout
        ...
        page-css="edit_habit.css"
        active="habits-management"
        page-title="Edit Habit"
        page-description="Update habit information"
    >
